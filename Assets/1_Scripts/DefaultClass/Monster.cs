...
public class Monster : MonoBehaviour
{
    ...
    [SerializeField] private List<Vector3> monster_pos;
    ...
    private void Awake()
    {
        monster_pos = new List<Vector3>();
        monster_pos.Add(new Vector3(-0.24f, -6.68f, 16.56f)); // Betrayal
        monster_pos.Add(new Vector3(-0.24f, -6.68f, 16.56f)); // Betrayal
        monster_pos.Add(new Vector3(-0.24f, -6.68f, 16.56f)); // Betrayal
        monster_pos.Add(new Vector3(-0.24f, -6.68f, 16.56f)); // Betrayal
        monster_pos.Add(new Vector3(-0.24f, -6.68f, 16.56f)); // Betrayal
