...
public class BattleManager : MonoBehaviour
{
    ...
    //public Image image_deck;
    //public Image image_grave;
    ...
    private void Awake()
    {
        ...
        //image_deck = GameObject.Find("Deck").GetComponent<Image>();
        //image_grave = GameObject.Find("Grave").GetComponent<Image>();

        //Color image_deck_color = image_deck.color;
        //Color image_grave_color = image_grave.color;
        //image_deck_color.a = 0f;
        //image_grave_color.a = 0f;
    ...
    {
        if(!YSUIManager.Instance.isPopupOpen)
        {
            ...
            if (currentState == eBattleState.LayOut)
            {
                ...
                CTH_UIManager.instance.HidePlaceUI();
                BattlePieceManager.instance.DisablePieces();
                CTH_UIManager.instance.OpenBattleUIs();
            }
    ...
    void StateUpdate()
    {
        switch (currentState)
        {
            ...
            case eBattleState.Draw:
                CTH_UIManager.instance.UpdateBattleUIs();
            ...
            case eBattleState.MonsterAttack: // 이때 몬스터 턴 UI 활성화
                ...
                //TurnPopupManager.Instance.ShowEnemyTurn();
