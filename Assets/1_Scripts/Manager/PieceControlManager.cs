            ...
            if (!BattleManager.BattleManagerInstance.GetCanLayOut())
            {
                if (Input.GetKeyDown(KeyCode.Alpha1))
                {
                        ...
                        if (piece == null)
                    {
                        ...
                        BattlePieceManager.instance.EffectSelectedPiece(GameObject.Find("StatusInfoUI").GetComponent<StatusInfoUI>().sort[0].GetComponent<StatusPiece>().piece);
                ...
                else if (Input.GetKeyDown(KeyCode.Alpha2))
                {
                    ...
                    {
                        BattlePieceManager.instance.DisableEffectPieces();
                        BattlePieceManager.instance.EffectSelectedPiece(GameObject.Find("StatusInfoUI").GetComponent<StatusInfoUI>().sort[1].GetComponent<StatusPiece>().piece);
                        PieceControlManager.instance.preventEffect = false;
                    }
                }
                else if (Input.GetKeyDown(KeyCode.Alpha3))
                {
                    ...
                    {
                        BattlePieceManager.instance.DisableEffectPieces();
                        BattlePieceManager.instance.EffectSelectedPiece(GameObject.Find("StatusInfoUI").GetComponent<StatusInfoUI>().sort[2].GetComponent<StatusPiece>().piece);
                        PieceControlManager.instance.preventEffect = false;
                    }
                }
                else if (Input.GetKeyDown(KeyCode.Alpha4))
                {
                    ...
                    {
                        BattlePieceManager.instance.DisableEffectPieces();
                        BattlePieceManager.instance.EffectSelectedPiece(GameObject.Find("StatusInfoUI").GetComponent<StatusInfoUI>().sort[3].GetComponent<StatusPiece>().piece);
                        PieceControlManager.instance.preventEffect = false;
                    }
                }
                else if (Input.GetKeyDown(KeyCode.Alpha5))
                {
                    ...
                    {
                        BattlePieceManager.instance.DisableEffectPieces();
                        BattlePieceManager.instance.EffectSelectedPiece(GameObject.Find("StatusInfoUI").GetComponent<StatusInfoUI>().sort[4].GetComponent<StatusPiece>().piece);
                        PieceControlManager.instance.preventEffect = false;
                    }
                }
                else if (Input.GetKeyDown(KeyCode.Alpha6))
                {
                    ...
                    {
                        BattlePieceManager.instance.DisableEffectPieces();
                        BattlePieceManager.instance.EffectSelectedPiece(GameObject.Find("StatusInfoUI").GetComponent<StatusInfoUI>().sort[5].GetComponent<StatusPiece>().piece);
                        PieceControlManager.instance.preventEffect = false;
                    }
                }
            }
