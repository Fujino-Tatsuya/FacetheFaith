...
public class BattleCardManager : CardManager
{
    ...
    private void Start()
    {
        if (GameManager.instance != null)
            if (GameManager.instance.currentState != GameState.Stage_Battle && GameManager.instance.currentState != GameState.BossBattle)
            {
                enabled = false;
            }
    }
    ...
    IEnumerator Co_Draw(int drawCount)
    {
        ...
        drawCoroutine = null;
        YSUIManager.Instance.UpdateCard();
    }
